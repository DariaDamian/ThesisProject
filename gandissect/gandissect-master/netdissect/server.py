...
# Outcommenting below line bc: 
# TypeError: FlaskApp.__init__() got an unexpected keyword argument 'debug'
...
if __name__ == '__main__':
    ...
    # Outcommented bc: run() got an unexpected keyword argument 'debug'
